  ...
  <div class="konten-form">
  	<h5 class="aan">Input Data Barang</h5>
  	<form method="post" action="<?php echo base_url()?>welcome/simpan">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input style="max-width: 100px;float: left;" type="text" class="form-control" name="berat"><label class="col-form-label" style="float: left; margin-left: 10px;">gram</label>
			      <br><br><?php echo form_error('berat','<div class="alert alert-danger" role="alert">', '</div>'); ?>
			    </div>
			  </div>
